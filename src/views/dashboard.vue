<template>
    <Vueform add-class="vf-my-form">
        <template #empty>
            <FormTabs>
                <FormTab name="page0" label="Paso 1" :elements="[
                    'h2',
                    'file',
                    'tags',
                    'submit',
                ]" />
                <FormTab name="page1" label="Paso 2" :elements="[
                    'h2_1',
                    'file_1',
                    'tags_1',
                    'submit_1',
                ]" />
                <FormTab name="page2" :elements="[
                    'h2_2',
                    'datetime',
                    'file_2',
                    'tags_2',
            ...
            <FormElements>
                <StaticElement name="h2" tag="h2" content="Solicitud constancia de representatividad" align="center" />
                <FileElement name="file" label="Documento" :drop="true" />
                <TagsElement name="tags" :close-on-select="false" :search="true" :items="[
                    {
                        value: 'Mart55jl@gmail.com',
                        label: 'Mart55jl@gmail.com',
                    },
                    {
                        value: 'rubenromo8@gmail.com',
                        label: 'rubenromo8@gmail.com',
                    },
                    {
                        value: 'jodacema@gmail.com',
                        label: 'jodacema@gmail.com',
                    },
                    {
                        value: 'jessy.camarillo09@gmail.com',
                        label: 'jessy.camarillo09@gmail.com',
                    },
                    {
                        value: 'pavon.gabriela812@gmail.com',
                        label: 'pavon.gabriela812@gmail.com',
                    },
                    {
                        value: 'jorgeromo@sindicatojs.org',
                        label: 'jorgeromo@sindicatojs.org',
                    },
                    {
                        value: 'dulce.torres@sindicatojs.org',
                        label: 'dulce.torres@sindicatojs.org',
                    },
                    {
                        value: 'pavon.gabriel@outlook.com',
                        label: 'pavon.gabriel@outlook.com',
                    },
                ]" label="Visible para:" input-type="search" autocomplete="off" />
                <ButtonElement name="submit" button-label="Submit" :submits="true" :conditions="[
                    [
                        'file',
                        'not_empty',
                    ],
                ...
                <StaticElement name="h2_1" tag="h2" content="Aviso de tramite" align="center" />
                <FileElement name="file_1" label="Documento" :drop="true" />
                <TagsElement name="tags_1" :close-on-select="false" :search="true" label="Visible para"
                    input-type="search" autocomplete="off" />
                <ButtonElement name="submit_1" button-label="Submit" :submits="true" :conditions="[
                    [
                        'file_1',
                        'not_empty',
                    ],
                ...
                <StaticElement name="h2_2" tag="h2" content="Constancia de representatividad" align="center" />
                <DateElement name="datetime" label="Datetime" :time="true" />
                <FileElement name="file_2" label="Documento" :drop="true" />
                <TagsElement name="tags_2" :close-on-select="false" :search="true" :items="[
                    {
                        value: 0,
                        label: 'Label',
                    },
                ]" label="Visible para" input-type="search" autocomplete="off" />
                <ButtonElement name="submit_2" button-label="Submit" :submits="true" :conditions="[
                    [
                        'datetime',
                        'not_empty',
                    ],
