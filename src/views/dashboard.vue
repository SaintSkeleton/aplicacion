<template>
      ...
      <template v-slot="file">
        <div class="m-5">
          <div class="flex items-center justify-center">
            <label v-if="!file.file.previewUrl" for="dropzone-file"
              ...
              <div class="flex flex-col items-center justify-center pt-5 pb-6 px-10">
                <img src="../../../assets/images/canvas.svg" alt="canvas"
            ...
            <div v-else>
              <div class="w-full h-64">
                <img v-if="file.file.previewType != 'video'" class="h-full w-full object-contain rounded-2xl"
  ...
  <div class="flex flex-wrap">
    <MultipleFileUpload :removeBtnText="'remove'" :uploadBtnText="'Save'" :progressBtnText="'Saving...'"
      :uploadedFiles="uploadedFiles" :callback="handleMultipleFileUpload">
      <template v-slot="file">
      </template>
    </MultipleFileUpload>
  </div>
...
export default {
  ...
  methods: {
    async handleFileUploading(file) {
